...
export default async function Dashboard() {
  ...
  return (
    <section className="relative min-h-screen flex bg-black overflow-hidden">
      ...
      <main className="relative flex-1 z-10 p-6 flex flex-col gap-8">
        {/* 1. Greeting */}
        <div className="w-full flex flex-col items-center justify-center mt-2 mb-4">
          <h1 className="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-yellow-400 via-orange-400 to-red-500 text-transparent bg-clip-text drop-shadow-[0_0_30px_rgba(255,165,0,0.7)] animate-pulse text-center">
            Welcome, <span className="text-white drop-shadow-[0_0_15px_#ffbf00]">{userData.username}</span>!
          </h1>
          <p className="mt-2 text-lg md:text-xl text-orange-100 text-center drop-shadow-[0_0_10px_rgba(255,165,0,0.4)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-4">
              <button className="flex-1 bg-gradient-to-r from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 text-black font-bold py-3 rounded-md shadow-lg transition-all">
                Deposit
              </button>
              <button className="flex-1 bg-gradient-to-r from-red-400 to-orange-400 hover:from-orange-500 hover:to-red-400 text-black font-bold py-3 rounded-md shadow-lg transition-all">
                Withdraw
              </button>
            </div>
          </div>
        ...
        <div className="bg-zinc-800 p-6 rounded-xl shadow-md mt-8">
          <h2 className="text-xl font-semibold mb-4 text-orange-300">Quick Trade</h2>
          <p className="text-gray-300 mb-4">Buy or sell your favorite cryptocurrencies instantly.</p>
          <div className="flex flex-col md:flex-row gap-4">
            <input
              type="number"
              placeholder="Amount"
              className="flex-1 p-3 rounded-md bg-zinc-700 text-white"
            />
            <select className="flex-1 p-3 rounded-md bg-zinc-700 text-yellow-400 font-bold">
              <option value="BTC">Bitcoin (BTC)</option>
              <option value="ETH">Ethereum (ETH)</option>
              <option value="USDT">Tether (USDT)</option>
            </select>
            <button className="bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-orange-500 hover:to-yellow-400 text-black font-bold py-3 px-6 rounded-md shadow-lg">
              Buy
            </button>
            <button className="bg-gradient-to-r from-red-400 to-orange-400 hover:from-orange-500 hover:to-red-400 text-black font-bold py-3 px-6 rounded-md shadow-lg">
              Sell
            </button>
          </div>
        </div>
        ...
        <div className="bg-zinc-800 p-6 rounded-xl shadow-md mt-8">
          <h2 className="text-xl font-semibold mb-4 text-orange-300">Recent Transactions</h2>
...
function MiningProgress() {
  ...
  return (
    <div className="bg-zinc-800 rounded-xl p-6 flex flex-col items-center justify-center shadow-md">
      <span className="text-orange-300 font-semibold mb-2">Mining Progress</span>
